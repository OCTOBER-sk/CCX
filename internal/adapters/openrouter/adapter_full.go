...
// OpenRouter adapter concrete implementation per spec 23 (lines 884-910):
// Provider catalog adapter supporting multiple upstream providers through single endpoint.
...
func (a *Adapter) DiscoverModels() ([]string, error) {
	return []string{"openrouter/anthropic", "openrouter/openai", "openrouter/google"}, nil
}
