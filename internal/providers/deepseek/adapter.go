...
// DeepSeek provider adapter per spec 23 (provider catalog, lines 886-910): DeepSeek.
import ("github.com/ccx/ccx/internal/protocol")
type Adapter struct{}
func New() protocol.Adapter { return &Adapter{} }
